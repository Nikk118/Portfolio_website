        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white text-slate-900 rounded-lg font-medium hover:bg-slate-50 transition-colors shadow-lg border-2 border-slate-200 flex items-center gap-2"
            >
